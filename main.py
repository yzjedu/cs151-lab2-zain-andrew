#Purpose: This lab gives practice with input, output, math,
# writing algorithms and test cases, and using human computer
# interaction's usability guidelines for user input and output.
# Users will use decision-making skills to state of the population
# increased or decreased.

# Programmers:  Andrew Leimbach, Zain Huda
# Course:  CS151, Mr. Zee
# Due Date: 9/18/2024
# Lab Assignment: 2
...
if future_population > current_population:
    ...
    print("The population stayed the same")
else:
